...
#' @param data the dataframe where to search the keyword. Usually generated by [read_trialmaster()]. Can be set using `options(edc_lookup=...)`.
...
#' \dontrun{
#' w = read_trialmaster("path/to/your/archive")
#' options(edc_lookup=w$.lookup)
#' find_keyword("foo")
#' }
#' 
