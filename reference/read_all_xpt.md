...
instead.  
Formats (factors levels) can be applied from a `procformat.sas` SAS
file, or from a format dictionary. See the "Format file" section below.
Column labels are read directly from the `.xpt` files.
...
#> Writing cache /tmp/Rtmpx3fTgt/read_all_xpt/EDCimport_cache_5b38f14b.rds
...
edc_lookup()
#> ── Lookup table - My great project (extraction of 2026-04-10) - EDCimport v0.7.0
