...
test_that("edc_swimmerplot", {
  ...
  p2 = edc_swimmerplot(.lookup, origin="enrol$enrol_date", time_unit="months", plotly=FALSE)
  p3 = edc_swimmerplot(.lookup, group="enrol$group", plotly=FALSE)
  p4 = edc_swimmerplot(.lookup, origin="enrol$enrol_date", group="enrol$group", plotly=FALSE)
  ...
  expect_error(edc_swimmerplot(.lookup, origin="xxx$enrol_date", plotly=FALSE), 
